...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text fontSize="4xl" color="#FEFEE8" textAlign="center" mt="">
        Welcome to Joseph Swap!
      </Text>
      <Text fontSize="2xl" color="#FEFEE8" textAlign="center" mt="1">
      ...
      >
        ...
        >
          ...
          tokenImage={
            ACTIVE_CHAIN.icon && ACTIVE_CHAIN.icon.url
              ? ACTIVE_CHAIN.icon.url
              : ''
          }
        />
